...
class FiniteAutomaton:
    ...
    def setName(self, newName):
        """Add a name to the automaton. This is used as the name of the image generated by
the visualize() method. The dafult name is the hash value of the object or, if existing, the name 
present in the dots format string at initialization"""
        self.name = "_" + newName
        
    def reverseTransitions(self, reduce: bool = False) -> "FiniteAutomaton":
        """Returns the NFA obtained from reversing all the transitions"""
        nfa = FiniteAutomaton(self.statesNumber + 1, self.statesNumber, [self.initState]) 
        ...
        # Add a new state that serves as an initial state
    ...
    def determinize(self, reduce: bool = False) -> "FiniteAutomaton":
        ...
        for i in range(newStatesNumber):
            ...
            # The subset of the old states containg only the initial state old state 
    ...
    def reduce(self) -> "FiniteAutomaton":
        ...
        newAutomaton = FiniteAutomaton(nVisited + 1, 1, newAcceptingStates)
